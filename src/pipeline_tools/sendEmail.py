...
parser.add_argument('-join', '--join-documents', type=str, required=False,nargs=1, help="Documents to be attached to mail .")
args = parser.parse_args()

if(args.addresses):
    writeEmail(args.addresses, args.subject[0], args.msg[0])
